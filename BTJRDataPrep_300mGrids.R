...
##################################### 27 Sept. 2022 - try to convert crs of routes to WGS 84 - same as raster
...
plot(st_geometry(BTJRdf), add=TRUE) #### DONT KNOW HOW TO ADD BTJR POINTS ON LINE YET 

################################################################################

#NOW TRY TO GET THE LINES (EITHER Nroute (POINTS) OR Nroute_line(LINES)) TO MATCH 
#RASTER CRS - WGS 84 
########################
